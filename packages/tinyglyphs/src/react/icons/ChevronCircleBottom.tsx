...
export const ChevronCircleBottomIcon = forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => (
    <IconBase ref={ref} {...props}>
      <g clipPath="url(#clip0_59_3732)">
...
ChevronCircleBottomIcon.displayName = "ChevronCircleBottomIcon";
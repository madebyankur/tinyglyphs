...
export const ArrowCircleTopIcon = defineComponent({
  name: 'ArrowCircleTopIcon',
  props: iconBaseProps,
  setup(props, { attrs }) {
    return () => h(IconBase, { ...props, ...attrs }, () => [
      h('path', {"d":"M8 11V5M8 5L5 8M8 5L11 8","stroke-width":"1.5","stroke-linecap":"round","stroke-linejoin":"round"}),

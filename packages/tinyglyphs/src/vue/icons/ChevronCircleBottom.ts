...
export const ChevronCircleBottomIcon = defineComponent({
  name: 'ChevronCircleBottomIcon',
  props: iconBaseProps,
  setup(props, { attrs }) {
    return () => h(IconBase, { ...props, ...attrs }, () => [
      h('path', {"d":"M5 7L8 10L11 7","stroke-width":"1.5","stroke-linecap":"round","stroke-linejoin":"round"}),
